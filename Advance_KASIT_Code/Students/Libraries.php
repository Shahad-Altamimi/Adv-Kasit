  ...
  <table data-toggle="data-table" class="table" cellspacing="0" width="100%" border="2">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="mailto:<?php echo $Email_Address; ?>" class="btn btn-primary"><?php echo $Email_Address; ?></a></td>
                  <td><?php echo $Address; ?></td>
                  <td><a href="View_Location.php?Name=<?php echo $Name; ?>&Longitude=<?php echo $Longitude; ?>&Latitude=<?php echo $Latitude; ?>" class="btn btn-primary">View Location</a></td>
