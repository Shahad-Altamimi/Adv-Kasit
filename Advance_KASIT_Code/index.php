...
$query1 = mysqli_query($Conn,"SELECT * FROM students WHERE Uni_Number='$Uni_Number' AND Password='$Password'"); 
...
echo '<script language="JavaScript">
			...
			$Status='Error ... Please Check Students Username Or Password !';
...
$query = mysqli_query($Conn,"SELECT * FROM instructors WHERE Username='$Username' AND Password='$Password'"); 
...
echo '<script language="JavaScript">
	...
	$Status2='Error ... Please Check Instructors Username Or Password !';
...
-->
  ...
  <div class="container">
    ...
    <div class="row" data-toggle="gridalicious">
	  ...
	  <div class="media-body">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
			  ...
			  <div class="panel-body">
			 <form action="Instructors_Signin.php" method="post">

            <div class="form-group">
			 			  						<h1>Instructors Sign in</h1>
	 ...
	 <div class="media-body">
          <div class="panel panel-default">
            <div class="panel-body">
              <div class="text-headline"><center><a href="All_Courses.php" class="navbar-btn btn btn-primary btn-lg">All Courses</a></center></div>
                          <div class="text-headline"><center><a href="All_Volunteers.php" class="navbar-btn btn btn-primary btn-lg">All Volunteers</a></center></div>
	  ...
	  <div class="media-body">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
			  ...
			  <div class="panel-body">
			  <form action="Students_Signin.php" method="post">

            <div class="form-group">
			 			  						<h1>Students Sign in</h1>

              <div class="form-control-material">
                <input class="form-control" id="username" style="border: 1px solid #000;" name="Uni_Number" type="text" placeholder="Uni Number" required>
                <center><font for="username">Uni Number</font></center>
              </div>
            </div>
            <div class="form-group">
 ...
 <center>
			...
			<a href="Student_Forget.php" class="btn btn-warning">Forget Password</a>
			<br><br>
			<a href="Students_Signup.php" class="btn btn-primary">You Don't Have Account? Signup Now !</a>
			
			<br>
			<strong><font color="red"><?php echo $Status; ?></font></strong>
			</center>
			</form>
          </div>
