            ...
            <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <a href="JavaScript:if(confirm('Are You Sure To Select This Course ?')==true)
{window.location='Select_Course.php?Department_Name=<?php echo $Department_Name; ?>&C_ID=<?php echo $C_ID; ?>';}" class="btn btn-success btn-sm" role="button">Select</a> 
