...
<body>
  ...
  <div class="navbar navbar-default navbar-fixed-top navbar-size-large navbar-size-xlarge paper-shadow" data-z="0" data-animated role="navigation">
	...
	?>
      ...
      <a href="http://ju.edu.jo/home.aspx" target="_blank" class="navbar-btn btn btn-primary" style="background-color:#fff"><img src="images/ju.png" width="32px"/></a>
          <a href="http://computer.ju.edu.jo/Home.aspx" target="_blank" class="navbar-btn btn btn-primary" style="background-color:#fff"><img src="images/kasit2.png" width="34px"/></a>
              ...
              <li class="list-group-item">
                <div class="media v-middle">
                  <div class="media-body">
                    <h4 class="text-headline margin-none">All Volunteers</h4>
                  </div>
...
<center>
  ...
  <table data-toggle="data-table" class="table" cellspacing="0" width="100%" border="2">
              ...
              <tbody>
			     ...
			     <?php
					$sql1 = mysqli_query($Conn,"select * from students where Volunteer_Status='Accept' order by Uni_Number DESC");
