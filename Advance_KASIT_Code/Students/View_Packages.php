          ...
          <div class="panel panel-default">
			...
			<table data-toggle="data-table" class="table" border="2" cellspacing="0" width="100%">
              ...
              <tbody>
			     ...
			     <?php
					$sql1 = mysqli_query($Conn,"select * from courses_packages where C_ID='$C_ID' order by ID DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$sql2 = mysqli_query($Conn,"select * from students where Uni_Number='$Std_ID'");
